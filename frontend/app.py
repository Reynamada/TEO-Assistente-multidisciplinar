...
def main():
    ...
    if current_page == "dashboard":
        ...
        exec(open(os.path.join(os.path.dirname(__file__), "pages", "01_recepcao.py"), encoding="utf-8").read(), globals())
    elif current_page == "evolucoes":
        exec(open(os.path.join(os.path.dirname(__file__), "pages", "02_terapeutas.py"), encoding="utf-8").read(), globals())
